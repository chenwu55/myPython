...
class Xzsc(Page):
    def xzsc(self,shenheren,password):
        xx=(u"CS法人"+time.strftime("%m.%d.%H_%M"))
        yy=(u"CS商场"+time.strftime("%m.%d.%H_%M"))    #商场名称
        mdmc=(u"CS门店"+time.strftime("%m.%d.%H_%M"))
        ...
        sleep(1)
        self.by_xpath_z("1",xx)
        self.by_xpath_z("2","555555555555555555")
        self.by_xpath_z("3","13533333333")
        self.by_xpath_z("5",u"白云新镇庄1号")
        self.by_xpath_z("6","555555")
        self.by_xpath_z("7",yy)
        self.by_xpath_x("8")
        sleep(0.5)
        ...
        self.by_xpath_z("13","555")
        self.by_xpath_z("14","0.55")
        self.by_xpath_b("1")
        sleep(0.5)
        self.by_xpath_b("11")
        self.by_xpath_b("21")
        ...
        self.by_xpath_z("26",u'广花三路366号欧派北区')
        self.by_xpath_z("27",u'小武哥')
        self.by_xpath_z("28",u'55555555555')
        self.by_xpath_z("29",u'广花三路366号欧派北区')
        self.by_xpath_s('(//*[@type="textarea"])[1]',u'店长有点懒')
        # jietu_name = yy +  u"截图_2.png"
        # function.insert_img(self.dr, jietu_name)
        self.by_xpath_z("31","admin")
        self.by_xpath_x("33")
        sleep(0.5)
        self.by_xpath('(//*[text()="今天"])[2]')
        self.by_xpath_x("34")
        sleep(1)
        self.by_xpath('/html/body/div[12]/div[1]/div/div[2]/table[1]/tbody/tr[7]/td[3]')
